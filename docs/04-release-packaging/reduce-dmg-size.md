...
Đây là runtime **độc lập** mà hai managed translation plugins gọi tới — main-process Electron **không bao giờ** `require` các package này (đã verify: chỉ duy nhất `src/document-tools/runtime.js` import chúng).
