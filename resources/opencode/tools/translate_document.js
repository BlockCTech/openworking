...
export default {
  description: "Translate a DOCX, Markdown, PDF, PPTX or XLSX into a new file in the same directory as the input file while preserving source formatting as closely as possible. Use this instead of writing ad hoc document conversion scripts.",
  args: {
    inputPath: schema.string().describe("Absolute path of the source .docx, .md, .markdown, .pdf, .pptx or .xlsx file, usually shown in the attachment context."),
