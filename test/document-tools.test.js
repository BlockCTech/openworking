...
test("translate_document rejects a missing inputPath before resolving the working directory", async () => {
  await assert.rejects(
    runtime.translateDocument({ targetLanguage: "Vietnamese" }, { directory: process.cwd() }),
