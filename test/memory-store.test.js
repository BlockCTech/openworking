...
const {
  ...
  projectMemoryPath,
  readMemory,
  shouldReloadRuntimeForMemorySave,
  writeMemory
...
test("shouldReloadRuntimeForMemorySave reloads only for global or active-project edits", () => {
  assert.equal(shouldReloadRuntimeForMemorySave("global", "proj_b", "proj_a", "running"), true)
  assert.equal(shouldReloadRuntimeForMemorySave("project", "proj_a", "proj_a", "running"), true)
  assert.equal(shouldReloadRuntimeForMemorySave("project", "proj_b", "proj_a", "running"), false)
  assert.equal(shouldReloadRuntimeForMemorySave("project", null, "proj_a", "running"), false)
  assert.equal(shouldReloadRuntimeForMemorySave("global", "proj_a", "proj_a", "stopped"), false)
})
