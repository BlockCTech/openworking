...
test("manifest requests the browser APIs and web host access required by browser tools", () => {
  ...
  // Native-host commands are not user gestures, so activeTab alone cannot authorize DOM reads or screenshots.
