...
This directory is the `desktop-client` nested git repository for OpenWorking. Follow this file before the workspace-root instructions when working inside this repo.
